...
several disadvantages to tracing. These
can be mitigated via sophisticated algorithms. The following chapters highlight
a selection of problems commonly occurring when implementing reference counting
garbage collection \cite[2. Overview]{gc-references_2021}.
