...
prevented by not exposing capabilities for manual memory management. A language
such as golang contains a garbage collector \cite[Introduction]{go_spec_2023}
enabling automatically releasing no longer used memory blocks, as shown in
listing \autoref{code:go_heap_alloc_example}.
