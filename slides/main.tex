...
\begin{document}
    ...
    \section{Borrow Checking}
        ...
        \begin{frame}
            \frametitle{Borrow Checking - Ownership und Borrowing}
            Ownership:
            \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Borrows dürfen nicht über den Lifetime des Owners hinausgehen, sichergegestellt durch den Borrow Checker
            \end{itemize}
        \end{frame}
